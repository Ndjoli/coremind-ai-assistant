...
os.environ["OPENAI_API_KEY"] = "sk-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"  # Replace with your actual key
...
if uploaded_file is not None:
    ...
    # ❓ Ask your question
    st.markdown("<h4 style='color: #ffffff;'>Ask a Question:</h4>", unsafe_allow_html=True)
